...
const ModalUpdatePersonalComputer: React.FC<
  ModalUpdatePersonalComputerProps
> = ({ isOpen, data, onDidDismiss }) => {
  ...
  return (
    <Modal
      title="Update Personal Computer"
      isOpen={isOpen}
      ...
      <form onSubmit={handleSubmit}>
        ...
        <IonItem>
          <IonInput
            ...
            onIonInput={(e) => handleInput("previousOwner", e.detail.value!)}
            required
          />
        </IonItem>
        <IonItem>
        ...
        <IonItem>
          <IonInput
            ...
            onIonInput={(e) => handleInput("username", e.detail.value!)}
            required
          />
        </IonItem>
        <IonItem>
          <IonInput
            ...
            onIonInput={(e) => handleInput("domain", e.detail.value!)}
            required
          />
        </IonItem>
        <IonItem>
          <IonInput
            ...
            onIonInput={(e) => handleInput("purchaseDate", e.detail.value!)}
            required
          />
        </IonItem>
        <IonItem>
        ...
        <IonItem>
          ...
          >
            ...
            <IonSelectOption value="Not Operating">
              Not Operating
            </IonSelectOption>
