            ...
            <IonContent className="bg-slate-600">
                ...
                <div className="bg-slate-600">
                    ...
                    <MenuItemDropDown headerText="Master Data" headerIcon={serverOutline}>
                        ...
                        <MenuItem url="/category" text="Category" icon={radioButtonOffOutline} />
                        <MenuItem url="/phone" text="Phone" icon={radioButtonOffOutline} />
                    </MenuItemDropDown>
                    <MenuItemDropDown headerText="Assets" headerIcon={fileTrayFullOutline}>
                        <MenuItem url="/personal-computer" text="Personal Computer" icon={radioButtonOffOutline} />
                        <MenuItem url="/software" text="Software" icon={radioButtonOffOutline} />
                    </MenuItemDropDown>
